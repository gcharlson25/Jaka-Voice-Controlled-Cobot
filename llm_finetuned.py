...
SYSTEM_PROMPT = (
    ...
    "HOME POSITION (SAFE):\n"
    "cobot.joint_move([math.radians(x) for x in [-273.900, 135.500, -115.723, 53.620, -91.834, -269.114]], ABS, True, 1.5)\n\n"
    ...
    "To start fastening:   cobot.set_digital_output(IO_CABINET, 9, 1)\n"
    "To stop fastening:    cobot.set_digital_output(IO_CABINET, 9, 0)\n"
    "To start unfastening: cobot.set_digital_output(IO_CABINET, 10, 1)\n"
    "To stop unfastening:  cobot.set_digital_output(IO_CABINET, 10, 0)\n"
